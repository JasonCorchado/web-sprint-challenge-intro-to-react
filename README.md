...
A: React is a library within javascript, from what i've learned thus far in using it is it allows us to configure the html using domanipulation and css using styled componnents. 

1. Describe component state. 
A: State is an object managed within a component and can be passed down as a prop. It can be changed using set state i.e setTime('3am)

1. Describe props.
A: A prop is an object that is passsed down from parent component.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
A: A Side effect is any changes that occur within a useEffect.
